...
LevelSelect:: LevelSelect(QWidget *parent): QMainWindow(parent)
{
    ...
    //back按钮图片待添加
    Button * back_bin = new Button(":/images/Backbutton.png");
...
void LevelSelect::paintEvent(QPaintEvent *){
    ...
    QPixmap pixmap(":/images/MainMenu.jpg");
