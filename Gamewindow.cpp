    ...
    m_gameWin(false)
{
    ...
    this->setWindowIcon(QIcon(":/images/Window1.jpeg"));
    ...
    Button * back_bin = new Button(":/images/back-button.png");
    ...
    Button * tower1 = new Button(":/images/Arrowtower0.png");
    ...
    Button * tower2 = new Button(":/images/Magictower0.png");
    ...
    Button * tower3 = new Button(":/images/Demontower0.png");
    ...
    Button * tower4 = new Button(":/images/Canontower0.png");
    ...
    Button * play = new Button(":/images/Button.png");
    play->setParent(this);
    play->move(1100,1010);

    Button * upgrade_bin = new Button(":/images/upgrade.png");
    ...
    Button * deletetower_bin = new Button(":/images/deletetower.png");
...
void GameWindow::paintEvent(QPaintEvent *){
    ...
    QPixmap luobo1(":/images/Maintower0.png");
    QPixmap luobo2(":/images/Maintower1.png");
    QPixmap luobo3(":/images/Maintower2.png");
    QPixmap luobo4(":/images/Maintower3.png");
    QPixmap luobo5(":/images/Maintower4.png");
    if(m_playerHp>=13){
